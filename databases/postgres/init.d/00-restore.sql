...
ALTER TYPE public.mpaa_rating OWNER TO admin;
...
ALTER DOMAIN public.year OWNER TO admin;
...
ALTER FUNCTION public._group_concat(text, text) OWNER TO admin;
...
ALTER FUNCTION public.film_in_stock(p_film_id integer, p_store_id integer, OUT p_film_count integer) OWNER TO admin;
...
ALTER FUNCTION public.film_not_in_stock(p_film_id integer, p_store_id integer, OUT p_film_count integer) OWNER TO admin;
...
ALTER FUNCTION public.get_customer_balance(p_customer_id integer, p_effective_date timestamp without time zone) OWNER TO admin;
...
ALTER FUNCTION public.inventory_held_by_customer(p_inventory_id integer) OWNER TO admin;
...
ALTER FUNCTION public.inventory_in_stock(p_inventory_id integer) OWNER TO admin;
...
ALTER FUNCTION public.last_day(timestamp without time zone) OWNER TO admin;
...
ALTER FUNCTION public.last_updated() OWNER TO admin;
...
ALTER FUNCTION public.rewards_report(min_monthly_purchases integer, min_dollar_amount_purchased numeric) OWNER TO admin;
...
ALTER AGGREGATE public.group_concat(text) OWNER TO admin;
...
ALTER TABLE public.actor_actor_id_seq OWNER TO admin;
...
ALTER TABLE public.actor OWNER TO admin;
...
ALTER TABLE public.film_film_id_seq OWNER TO admin;
...
ALTER TABLE public.film OWNER TO admin;
...
ALTER TABLE public.film_actor OWNER TO admin;
...
ALTER TABLE public.film_category OWNER TO admin;
...
ALTER TABLE public.actor_info OWNER TO admin;
...
ALTER TABLE public.customer_list OWNER TO admin;
...
ALTER TABLE public.film_list OWNER TO admin;
...
ALTER TABLE public.inventory_inventory_id_seq OWNER TO admin;
...
ALTER TABLE public.language_language_id_seq OWNER TO admin;
...
ALTER TABLE public.nicer_but_slower_film_list OWNER TO admin;
...
ALTER TABLE public.payment_payment_id_seq OWNER TO admin;
...
ALTER TABLE public.rental_rental_id_seq OWNER TO admin;
...
ALTER TABLE public.rental OWNER TO admin;
...
ALTER TABLE public.sales_by_film_category OWNER TO admin;
...
ALTER TABLE public.staff_staff_id_seq OWNER TO admin;
...
ALTER TABLE public.store_store_id_seq OWNER TO admin;
...
ALTER TABLE public.sales_by_store OWNER TO admin;
...
ALTER TABLE public.staff_list OWNER TO admin;
